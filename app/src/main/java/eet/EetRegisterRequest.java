...
//import openeet.lite.EetTrustManager;
import eet.EetTrustManager;

import openeet.lite.SSLSocketFactoryTLS11;
...
public class EetRegisterRequest {
	...
	public static class Builder {
		...
		public Builder fromDTO(openeet.lite.EetHeaderDTO dto){
			if (dto==null) return this;
			this
	...
	public static String formatPkp(byte[] _pkp) {
		...
		return openeet.lite.Base64.encodeToString(_pkp, openeet.lite.Base64.NO_WRAP);
	}

	public static byte[] parsePkp(String _pkp) {
		return openeet.lite.Base64.decode(_pkp, openeet.lite.Base64.NO_WRAP);
	}
	 ...
	 * @return
	 */
	public String generateSoapRequest(openeet.lite.EetHeaderDTO header){
	 ...
	 * @return
	 */
	public openeet.lite.EetHeaderDTO getLastHeader(){
		return lastHeader;
	}
	
	protected openeet.lite.EetHeaderDTO lastHeader;
	...
	protected String generateSoapRequestInternal(Date dat_odesl_force, PrvniZaslani prvni_zaslani_force, String uuid_zpravy_force, Overeni overeni_force){
		try {
			lastHeader=new openeet.lite.EetHeaderDTO();
			...
			String digest= openeet.lite.Base64.encodeToString(digestRaw, openeet.lite.Base64.NO_WRAP);
			...
			String signature= openeet.lite.Base64.encodeToString(signatureRaw, openeet.lite.Base64.NO_WRAP);
...
private HashMap<String,String> prepareValues(Date dat_odesl_force,PrvniZaslani prvni_zaslani_force,String uuid_zpravy_force,Overeni overeni_force) throws Exception
  {
    ...
    values.put("certb64",certificate!=null? openeet.lite.Base64.encodeToString(certificate.getEncoded(), Base64.NO_WRAP):null);
  ...
  private String fillTemplate(String template,HashMap<String,String> values)
  {
	...
	public openeet.lite.EetHeaderDTO getEetHeaderDTO(){
		openeet.lite.EetHeaderDTO dto=new EetHeaderDTO();
